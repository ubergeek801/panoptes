...
public class Hazelcast4CacheMetrics extends CacheMeterBinder {
   ...
   *
   * @return The instrumented cache, unchanged. The original cache is not wrapped or proxied in any
   *     way.
   */
   ...
   *     The cache to instrument.
   * @param tags
   *     Tags to apply to all recorded metrics. Must be an even number of arguments representing
