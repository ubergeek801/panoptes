...
public class SecurityAttributesTest {
  ...
  public void testAsSortedMap() {
    ...
    assertEquals(SecurityAttribute.country, sortedAttributeIterator.next(),
        "unexpected element order");
    assertEquals(SecurityAttribute.duration, sortedAttributeIterator.next(),
        "unexpected element order");
    assertEquals(SecurityAttribute.isin, sortedAttributeIterator.next(),
        "unexpected element order");
    assertEquals(SecurityAttribute.issuer, sortedAttributeIterator.next(),
        "unexpected element order");
    assertEquals(SecurityAttribute.price, sortedAttributeIterator.next(),
        "unexpected element order");
  }
}
