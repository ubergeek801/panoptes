...
public class WeightedAveragePositionCalculatorTest {
  ...
  public void testCalculateWeightedAverage() {
    ...
    assertEquals((132_500d / 1500), calculator
            .calculate(TestUtil.p1.getPositionsWithContext(TestUtil.defaultTestEvaluationContext())),
    ...
    assertEquals((130_000d / 1500), calculator
            .calculate(TestUtil.p2.getPositionsWithContext(TestUtil.defaultTestEvaluationContext())),
