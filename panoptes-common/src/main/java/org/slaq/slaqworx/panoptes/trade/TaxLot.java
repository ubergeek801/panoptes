...
public class TaxLot extends SimplePosition {
   ...
   *
   * @param amount
   *     the amount of the {@link Security} exchanged in this {@link TaxLot}
   * @param securityKey
   *     the {@link SecurityKey} identifying the {@link Security} being exchanged
   */
   ...
   *
   * @param positionKey
   *     a {@link PositionKey} identifying this {@link TaxLot}
   * @param amount
   *     the amount of the {@link Security} exchanged in this {@link TaxLot}
   * @param securityKey
   *     the {@link SecurityKey} identifying the {@link Security} being exchanged
