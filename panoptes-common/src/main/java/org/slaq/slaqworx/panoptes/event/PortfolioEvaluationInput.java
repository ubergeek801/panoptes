...
public class PortfolioEvaluationInput implements ProtobufSerializable {
  @Nonnull private final EvaluationSource evaluationSource;
  @Nonnull private final PortfolioKey portfolioKey;
  @Nonnull private final ArrayList<Rule> rules;

  public PortfolioEvaluationInput(
      @Nonnull EvaluationSource evaluationSource,
      @Nonnull PortfolioKey portfolioKey,
      @Nonnull RulesProvider rulesProvider) {
