...
public interface TradeEvaluator {
   ...
   *
   * @param trade
   *     the {@link Trade} to be evaluated
   ...
   *     if the {@link Thread} was interrupted during evaluation
   */
   ...
   * <p>
   * This method uses a binary search algorithm to attempt to converge on an approximate maximum. It
   * will first attempt to allocate {@code MIN_ALLOCATION}, followed by the full target value, after
