...
/**
 * Encapsulates the results of a single {@code Rule} evaluation, typically grouped by {@code
 * EvaluationGroup} and aggregated into an {@code EvaluationResult}. Currently this class contains
 ...
 * portoflio and the benchmark portfolio individually, to be combined eventually by a {@code
 * BenchmarkComparator}.
 *
 * @author jeremy
 */
public class ValueResult {
  ...
  /**
   * Creates a new value-based {@code RuleResult} indicating the threshold status for
   * evaluation and
   * the actual result value.
   *
   * @param threshold
   *     a {@code Threshold} value indicating whether the value is within the evaluation threshold
   * @param value
