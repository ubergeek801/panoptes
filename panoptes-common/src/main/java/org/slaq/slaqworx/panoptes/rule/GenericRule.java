...
public abstract class GenericRule implements Rule {
  @Nonnull private final RuleKey key;
  @Nonnull private final String description;
  @Nonnull private final EvaluationGroupClassifier groupClassifier;
  @Nonnull private final ArrayList<GroupAggregator> groupAggregators = new ArrayList<>();

  /**
   * Creates a new {@link GenericRule} with the given key and description.
   *
   * @param key the unique key to assign to the {@link Rule}, or {@code null} to generate one
   * @param description the description of the {@link Rule}
   */
   ...
   */
  protected GenericRule(
      RuleKey key, @Nonnull String description, EvaluationGroupClassifier groupClassifier) {
   ...
   * @param evaluationGroup the {@link EvaluationGroup} on which the {@link Rule} is being evaluated
   * @param evaluationContext the {@link EvaluationContext} under which to evaluate
   * @return the result of the {@link Rule} evaluation
   */
  @Nonnull
  protected abstract ValueResult eval(
      @Nonnull PositionSupplier positions,
