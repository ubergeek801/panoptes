 ...
 *
 * <p>Indirect holdings may be transitive, meaning that the above example could be extended with
 * {@link Portfolio} C, D, etc. The relationships between held {@link Portfolio}s form a directed
 * acyclic graph, where the "acyclic" property is assumed.
 *
 * @author jeremy
 */
public class ScaledPosition extends AbstractPosition {
  @Nonnull private final Position sourcePosition;
   ...
   * {@link Position}.
   *
   * @param sourcePosition the {@link Position} of which this {@link ScaledPosition} represents a
   *     fractional share
   * @param scale the fraction of the source {@link Position} represented by this {@link
   *     ScaledPosition}
   */
