 ...
 * necessary.
 *
 * <p>Because a {@link PositionSet} associated with a {@link Portfolio} may not comprise all of its
 ...
 *
 * <p>Note that the {@link Position}s within a {@link PositionSet} should generally be unique, but
 * for performance reasons, this is not enforced by {@link PositionSet}. While this class does not
 * depend on uniqueness, any calculations based on the {@link Position}s may be skewed if duplicate
 * {@link Position}s are present.
 *
 * @param <P> the concrete {@link Position} type provided by this {@link PositionSet}
 * @author jeremy
 */
public class PositionSet<P extends Position> implements HierarchicalPositionSupplier {
  ...
  @Nonnull private final ArrayList<P> positions;
   ...
   * {@link Portfolio}.
   *
   * @param positions the {@link Position}s that will comprise this {@link PositionSet}
   */
   ...
   *
   * @param positions the {@link Position}s that will comprise this {@link PositionSet}
   * @param portfolioKey the (possibly {@code null}) {@link PortfolioKey} associated with this
   *     {@link PositionSet}
   */
   ...
   */
  public PositionSet(
      @Nonnull Collection<P> positions, PortfolioKey portfolioKey, Double portfolioMarketValue) {
