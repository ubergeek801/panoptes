...
public class RoomEvaluationRequest
     ...
     *
     * @param portfolioKey
     *            the {@code PortfolioKey} identifying the {@code Portfolio} in which room is to be
     *            found
     * @param securityKey
     *            the {@code SecurityKey} identifying the {@code Security} for which to find room in
     *            the specified {@code Portfolio}
     * @param targetValue
