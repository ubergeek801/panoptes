...
/**
 * A {@code ProtobufSerializer} which (de)serializes the state of a {@code Rule} (actually a {@code
 * ConfigurableRule}.
 * <p>
...
public class RuleSerializer implements ProtobufSerializer<ConfigurableRule> {
   ...
   *     the name of the Java class implementing the classifer, or {@code null} if not applicable
  ...
  public static ConfigurableRule constructRule(String id, String description,
                                               String ruleClassName, String configuration,
                                               String groovyFilter,
   ...
   * @param ruleId
   *     the rule ID for which the {@code Class} is being instantiated (for logging purposes)
   * @param ruleDescription
   *     the rule description for which the {@code Class} is being instantiated (for logging
   *     purposes)
   *
