...
public class WeightedAveragePositionCalculatorTest {
    ...
    public void testCalculateWeightedAverage() {
        ...
        assertEquals((132_500d / 1500), calculator.calculate(TestUtil.p1, new EvaluationContext()),
        ...
        assertEquals((130_000d / 1500), calculator.calculate(TestUtil.p2, new EvaluationContext()),
        ...
        assertEquals(88d, calculator.calculate(TestUtil.p1, new EvaluationContext()),
                TestUtil.EPSILON, "unexpected weighted average for p1");
        ...
        assertEquals(88d, calculator.calculate(TestUtil.p2, new EvaluationContext()),
                TestUtil.EPSILON, "unexpected weighted average for p2");
    }
}
