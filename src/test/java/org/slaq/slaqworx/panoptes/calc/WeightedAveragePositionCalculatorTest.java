...
public class WeightedAveragePositionCalculatorTest {
    ...
    public void testCalculateWeightedAverage() {
        ...
        assertEquals("unexpected weighted average for p1", (132_500d / 1500), calculator
                .calculate(TestUtil.p1, new EvaluationContext(null, securityProvider, null)),
                TestUtil.EPSILON);
        ...
        assertEquals("unexpected weighted average for p2", (130_000d / 1500), calculator
                .calculate(TestUtil.p2, new EvaluationContext(null, securityProvider, null)),
                TestUtil.EPSILON);
        ...
        assertEquals("unexpected weighted average for p1", 88d, calculator.calculate(TestUtil.p1,
                new EvaluationContext(null, securityProvider, null)), TestUtil.EPSILON);
