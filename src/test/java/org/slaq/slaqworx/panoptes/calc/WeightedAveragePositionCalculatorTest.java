...
public class WeightedAveragePositionCalculatorTest {
    ...
    public void testCalculateWeightedAverage() {
        ...
        assertEquals((132_500d / 1500),
                calculator.calculate(TestUtil.p1.getPositionsWithContext(context)),
        ...
        assertEquals((130_000d / 1500),
                calculator.calculate(TestUtil.p2.getPositionsWithContext(context)),
        ...
        assertEquals(88d, calculator.calculate(TestUtil.p1.getPositionsWithContext(context)),
                TestUtil.EPSILON, "unexpected weighted average for p1");
        ...
        assertEquals(88d, calculator.calculate(TestUtil.p2.getPositionsWithContext(context)),
                TestUtil.EPSILON, "unexpected weighted average for p2");
    }
}
