...
/**
 * A {@code KafkaClient} that publishes various types of data to various topics. As a {@code
...
public interface KafkaProducer {
  ...
  void publishBenchmarkEvent(@KafkaKey PortfolioKey benchmarkKey,
                             PortfolioEvent benchmarkEvent);

  @Topic("${kafka-topic.portfolio-topic}")
  void publishPortfolioEvent(@KafkaKey PortfolioKey portfolioKey,
  ...
  void publishPortfolioResult(@KafkaKey PortfolioKey portfolioKey,
